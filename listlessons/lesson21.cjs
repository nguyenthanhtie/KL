  ...
  game: {
    basic: [
      ...
      },
      {
        ...
        options: ["Hiđro và Nitơ", "Oxi và Cacbonic", "Hiđro và Oxi", "Hiđro và Clo"],
        correctAnswer: 2,
    ...
    intermediate: [
      {
        ...
        options: ["NaOH và O₂", "Na₂O và H₂", "NaOH và H₂", "Không phản ứng"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Muối ăn (NaCl)", "Cát (SiO₂)", "Đường (C₁₂H₂₂O₁₁)", "Dầu ăn"],
        correctOrder: ["Muối ăn (NaCl)", "Đường (C₁₂H₂₂O₁₁)", "Dầu ăn", "Cát (SiO₂)"],
