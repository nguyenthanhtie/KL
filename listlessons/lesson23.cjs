    ...
    basic: [
      {
        ...
        options: ["Phản ứng thế", "Phản ứng hóa hợp", "Phản ứng phân hủy", "Phản ứng trung hòa"],
        correctAnswer: 3,
      ...
      },
      {
        ...
        options: ["Cu và H₂O", "CuO và H₂O", "Cu₂O và H₂O", "Không bị nhiệt phân"],
        correctAnswer: 1,
    ...
    intermediate: [
      {
        ...
        options: ["BaCl₂ và H₂SO₄", "NaOH và HCl", "CaCO₃ và HCl", "AgNO₃ và NaCl"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        pairs: [
          { left: "AgNO₃ + KCl", right: "Tạo chất kết tủa (AgCl)" },
          { left: "K₂CO₃ + H₂SO₄", right: "Tạo chất khí (CO₂)" },
          { left: "Ba(OH)₂ + HNO₃", right: "Tạo nước (H₂O)" }
        ],
      ...
      },
      {
        ...
        options: ["CuSO₄ + 2NaOH → Cu(OH)₂↓ + Na₂SO₄", "Fe + 2HCl → FeCl₂ + H₂↑", "2KCl + Mg(NO₃)₂ → 2KNO₃ + MgCl₂", "Zn + CuSO₄ → ZnSO₄ + Cu"],
        correctAnswer: 2,
    ...
    advanced: [
      {
        ...
        options: ["Dung dịch NaOH", "Dung dịch AgNO₃", "Quỳ tím", "Dung dịch HCl"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["23.3g", "17.1g", "32.3g", "2.33g"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["CaCl₂ + Na₂CO₃", "Ca(OH)₂ + CO₂", "Ca(HCO₃)₂ + NaOH", "Tất cả các đáp án trên"],
        correctAnswer: 0,
