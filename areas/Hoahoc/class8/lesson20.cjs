    ...
    basic: [
      {
        ...
        options: ["Zn và H₂O", "Zn và dung dịch HCl", "Cu và dung dịch HCl", "Zn và dung dịch NaCl"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Hai đơn chất", "Hai hợp chất", "Đơn chất và hợp chất", "Một chất và oxi"],
        correctAnswer: 2,
    ...
    intermediate: [
      {
        ...
        options: ["AlSO₄ và H₂", "Al₂(SO₄)₃ và H₂O", "Al₂(SO₄)₃ và H₂", "Không phản ứng"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        pairs: [
          ...
          { left: "Cho Zn tác dụng với HCl", right: "Phòng thí nghiệm" },
          { left: "Cho hơi nước qua than nóng đỏ", right: "Công nghiệp" }
        ],
      ...
      },
      {
      ...
      },
       {
        ...
        slots: [
          { id: 1, label: "Muối", accepts: ["FeSO₄"] },
          { id: 2, label: "Khí", accepts: ["H₂"] }
        ],
        options: ["FeSO₄", "H₂", "Fe₂(SO₄)₃", "H₂O"],
