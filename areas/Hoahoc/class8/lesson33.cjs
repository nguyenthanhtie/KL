  ...
  game: {
    ...
    intermediate: [
      ...
      },
      {
        ...
        pairs: [
          { left: "Kẽm tan dần", right: "Phản ứng Zn + H₂SO₄" },
          { left: "Có khí thoát ra", right: "H₂ được tạo ra" },
          { left: "Kêu 'pop' nhẹ", right: "H₂ tinh khiết" },
          { left: "Có hơi nước", right: "H₂ cháy tạo H₂O" }
        ],
    ...
    advanced: [
      {
        ...
        inline: true,
        slots: [
          { id: 1, label: "Thao tác", correct: "đưa gần lửa" },
          { id: 2, label: "Hiện tượng 1", correct: "kêu pop nhẹ" },
          { id: 3, label: "Hiện tượng 2", correct: "nổ mạnh" }
        ],
        options: ["đưa gần lửa", "kêu pop nhẹ", "nổ mạnh", "không cháy"],
      ...
      },
      {
        ...
        pairs: [
          { left: "Không kiểm tra độ tinh khiết", right: "Nguy cơ nổ" },
          { left: "Dùng H₂SO₄ đặc", right: "Phản ứng quá mạnh" },
          { left: "Không đeo kính", right: "Axit bắn vào mắt" },
          { left: "Hít khí H₂", right: "Thiếu oxy, ngạt thở" }
        ],
