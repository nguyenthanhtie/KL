    ...
    intermediate: [
      {
        ...
        pairs: [
          ...
          { left: "Tác dụng với Na", right: "Tính chất hóa học" },
          { left: "Sôi ở 100°C", right: "Tính chất vật lý" },
          { left: "Bị điện phân", right: "Tính chất hóa học" }
        ],
    ...
    advanced: [
      {
        ...
        inline: true,
        slots: [
          { id: 1, label: "Công thức", correct: "H₂O" },
          { id: 2, label: "Số H", correct: "2" },
          { id: 3, label: "Số O", correct: "1" }
        ],
        options: ["H₂O", "2", "1", "3"],
      ...
      },
      {
        ...
        pairs: [
          { left: "CaO + H₂O → Ca(OH)₂", right: "Oxit bazơ" },
          { left: "SO₃ + H₂O → H₂SO₄", right: "Oxit axit" },
          { left: "Na₂O + H₂O → 2NaOH", right: "Oxit bazơ" },
          { left: "P₂O₅ + 3H₂O → 2H₃PO₄", right: "Oxit axit" }
        ],
