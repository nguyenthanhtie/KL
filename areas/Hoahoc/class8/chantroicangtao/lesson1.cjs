// Bài 1 - Chân trời sáng tạo: Sử dụng hóa chất, dụng cụ an toàn
module.exports = {
  classId: 8,
  ...
  lessonId: 1,
  title: "Bài 1: Sử dụng hóa chất, dụng cụ và thiết bị an toàn",
  description: "Nhận diện hóa chất, dụng cụ cơ bản và thao tác an toàn trong phòng thí nghiệm",
  level: "Beginner",
  order: 1,
  theory: `
    <h2>🧪 Bài 1: Sử dụng hóa chất, dụng cụ và thiết bị an toàn</h2>
