    ...
    intermediate: [
      {
        ...
        pairs: [
          { left: "C% = (m<sub>ct</sub>/m<sub>dd</sub>) × 100%", right: "Nồng độ phần trăm" },
          { left: "C<sub>M</sub> = n/V", right: "Nồng độ mol" },
          { left: "n = m/M", right: "Số mol" },
          { left: "m<sub>dd</sub> = m<sub>ct</sub> + m<sub>dm</sub>", right: "Khối lượng dung dịch" }
        ],
    ...
    advanced: [
      {
        ...
        inline: true,
        slots: [
          { id: 1, label: "Tử số 1", correct: "C%" },
          { id: 2, label: "Tử số 2", correct: "m<sub>dd</sub>" },
          { id: 3, label: "KL chất tan", correct: "m<sub>ct</sub>" },
          { id: 4, label: "KL nước", correct: "(m<sub>dd</sub> - m<sub>ct</sub>)" }
        ],
        options: ["C%", "m<sub>dd</sub>", "m<sub>ct</sub>", "(m<sub>dd</sub> - m<sub>ct</sub>)"],
      ...
      },
      {
        ...
        pairs: [
          { left: "Biết m<sub>ct</sub>, m<sub>dm</sub> → Tìm C%", right: "C% = m<sub>ct</sub>/(m<sub>ct</sub>+m<sub>dm</sub>) × 100%" },
          { left: "Biết C%, m<sub>dd</sub> → Tìm m<sub>ct</sub>", right: "m<sub>ct</sub> = (C% × m<sub>dd</sub>)/100" },
          { left: "Biết m, M → Tìm n", right: "n = m/M" },
          { left: "Biết n, V → Tìm C<sub>M</sub>", right: "C<sub>M</sub> = n/V" }
        ],
