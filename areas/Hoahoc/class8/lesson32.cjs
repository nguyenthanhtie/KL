    ...
    advanced: [
      {
        ...
        inline: true,
        slots: [
          { id: 1, label: "Hệ số H₂", correct: "3" },
          { id: 2, label: "Hệ số Fe", correct: "2" },
          { id: 3, label: "Hệ số H₂O", correct: "3" }
        ],
        options: ["2", "3", "3", "1"],
      ...
      },
      {
        ...
        pairs: [
          { left: "2H₂ + O₂ → 2H₂O", right: "H₂ bị oxi hóa" },
          { left: "H₂ + CuO → Cu + H₂O", right: "H₂ là chất khử" },
          { left: "H₂ + Cl₂ → 2HCl", right: "H₂ tạo hợp chất" },
          { left: "Zn + H₂SO₄ → ZnSO₄ + H₂", right: "H₂ là sản phẩm" }
        ],
      ...
      },
      {
        ...
        options: ["1,12 lít", "2,24 lít", "3,36 lít", "4,48 lít"],
        correctAnswer: 1,
