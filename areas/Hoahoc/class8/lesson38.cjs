    ...
    intermediate: [
      {
        ...
        pairs: [
          { left: "Nước muối", right: "Dung dịch lỏng" },
          { left: "Không khí", right: "Dung dịch khí" },
          { left: "Đồng thau", right: "Dung dịch rắn" },
          { left: "Nước đường", right: "Dung dịch lỏng" }
        ],
    ...
    advanced: [
      {
        ...
        inline: true,
        slots: [
          { id: 1, label: "Thành phần 1", correct: "Chất tan" },
          { id: 2, label: "Thành phần 2", correct: "Dung môi" },
          { id: 3, label: "Đặc điểm", correct: "đồng nhất" }
        ],
        options: ["Chất tan", "Dung môi", "đồng nhất", "không đồng nhất"],
      ...
      },
      {
        ...
        pairs: [
          { left: "Nước muối sinh lý", right: "NaCl + H₂O" },
          { left: "Nước có ga", right: "CO₂ + H₂O" },
          { left: "Không khí", right: "N₂ + O₂ + CO₂..." },
          { left: "Giấm ăn", right: "CH₃COOH + H₂O" }
        ],
