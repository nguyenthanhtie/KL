    ...
    intermediate: [
      {
        ...
        pairs: [
          { left: "Không màu, không mùi", right: "Tính chất vật lý" },
          { left: "Cháy trong oxi", right: "Tính chất hóa học" },
          { left: "Nhẹ nhất", right: "Tính chất vật lý" },
          { left: "Khử oxit kim loại", right: "Tính chất hóa học" }
        ],
    ...
    advanced: [
      {
        ...
        inline: true,
        slots: [
          { id: 1, label: "Tính chất", correct: "khử" },
          { id: 2, label: "Chất bị khử", correct: "oxit" },
          { id: 3, label: "Sản phẩm", correct: "kim loại" }
        ],
        options: ["khử", "oxit", "kim loại", "muối"],
      ...
      },
      {
        ...
        pairs: [
          { left: "Bơm bóng bay", right: "Nhẹ nhất" },
          { left: "Nhiên liệu tên lửa", right: "Cháy tỏa nhiều nhiệt" },
          { left: "Hàn cắt kim loại", right: "Ngọn lửa nhiệt độ cao" },
          { left: "Khử quặng sắt", right: "Có tính khử" }
        ],
