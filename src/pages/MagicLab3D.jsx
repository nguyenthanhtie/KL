...
const MagicLab3D = () => {
  ...
  return (
    <div 
      className="relative w-full h-screen overflow-hidden font-sans text-white select-none transition-colors duration-1000"
    ...
    >
      ...
      {/* 1. Nút quay lại (Top Left) */}
      <div className="absolute top-6 left-6 z-20 flex gap-4">
        <button 
          onClick={() => navigate(-1)}
          className="p-3 bg-white/5 hover:bg-white/10 rounded-full backdrop-blur-md border border-white/10 transition-all hover:scale-110 active:scale-95"
          title="Quay lại"
        >
          <ArrowLeft size={24} />
        </button>
      ...
      {activeBeaker.contents.length >= 2 && (
         <div className="absolute bottom-32 left-1/2 -translate-x-1/2 z-20">
            <button 
               onClick={() => splitProducts(activeBeakerIndex)}
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30 pointer-events-auto">
         <div className="flex items-center bg-black/60 backdrop-blur-2xl border border-white/10 rounded-full px-8 py-3 space-x-10 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
         ...
         <div className="group relative">
            ...
            <div className="absolute bottom-full right-0 mb-4 w-72 bg-black/90 backdrop-blur-2xl border border-white/10 p-5 rounded-3xl opacity-0 group-hover:opacity-100 transition-all pointer-events-none transform translate-y-4 group-hover:translate-y-0 text-xs shadow-2xl">
               ...
               <ul className="space-y-2 text-white/70 leading-relaxed">
                  ...
                  <li>• Khi có  1 chất, dùng nút <b>Scissors</b> để tách sản phẩm.</li>
