...
export const REACTIONS = [
  ...
  },
  {
    ...
    message: "💣 Rb + H₂O → RbOH + H₂↑ — NỔ CỰC MẠNH! Rubidi phản ứng dữ dội với nước."
  },
  {
  ...
  },
  {
    ...
    message: "🔥 14KMnO₄ + 4C₃H₅(OH)₃ → 7K₂CO₃ + 7Mn₂O₃ + 5CO₂↑ + 16H₂O — Phản ứng tự bốc cháy cực mạnh với khói tím và lửa sáng chói!"
  },
  {
  ...
  },
  {
    ...
    message: "🔥 Fe + 2HCl → FeCl₂ + H₂↑ — Sắt tan trong axit, sủi bọt khí"
  },
  {
  ...
  },
  {
    ...
    message: "🌟 2Mg + O₂ → 2MgO — Magie cháy sáng chói lòa trong không khí!"
  },
  {
  ...
  },
  {
    ...
    message: "🔥 C₂H₅OH + 3O₂ —(Heat)→ 2CO₂ + 3H₂O — Rượu cháy rực rỡ với ngọn lửa xanh mờ."
  },
  {
    // KMnO4 + HCl -> Cl2
    reactants: ['KMnO4', 'HCl'],
  ...
  },
  {
    ...
    message: "💨 Axit Clohidric đang bốc khói (hiện tượng bốc khói trong không khí ẩm)!"
  },
  {
    reactants: ['HNO3'],
    products: ['HNO3'],
  ...
  },
  {
    ...
    message: "🫧 2Al + 3H₂SO₄ → Al₂(SO₄)₃ + 3H₂↑ — Nhôm tan trong axit sunfuric loãng giải phóng khí Hydro."
  },
  {
    // C + O2 -> CO2 (Heat)
    reactants: ['C'],
    ...
    message: "🔥 C + O₂ —(Heat)→ CO₂ — Cacbon cháy trong không khí tạo khí cacbonic."
  },
  {
    // S + O2 -> SO2 (Heat)
    reactants: ['S'],
    ...
    message: "🔥 S + O₂ —(Heat)→ SO₂ — Lưu huỳnh cháy với ngọn lửa xanh nhạt, mùi hắc khó chịu."
  },
  {
    ...
    message: "⬜ BaCl₂ + H₂SO₄ → BaSO₄↓ + 2HCl — Kết tủa trắng Bari Sunfat bền vững không tan trong axit."
  }
];
