...
const Bai07_KimLoaiKiem_KiemTho_Nhom = () => {
  ...
  const { hasProgress, savedProgress, saveProgress, clearProgress } = useChallengeProgress('kiem_kiemtho_nhom_12', { challengeId: 'kiem_kiemtho_nhom_12', programId: 'chemistry', grade: 12 });
