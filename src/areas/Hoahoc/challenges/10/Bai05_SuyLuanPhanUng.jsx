...
import { ArrowLeft, Trophy, Target, Brain, Lightbulb } from 'lucide-react';
import useChallengeProgress from '../../../../hooks/useChallengeProgress';
import ResumeDialog from '../../../../components/ResumeDialog';
import './CSS/Bai05_SuyLuanPhanUng.css';
...
export default function SuyLuanPhanUng() {
  ...
  useEffect(() => {
    const onError = (event) => {
      ...
      console.error('Captured error in SuyLuanPhanUng:', event);
      setRenderError(msg);
    };
  ...
  if (!levels || levels.length === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-600 via-pink-600 to-red-600">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="bg-white rounded-2xl shadow-2xl p-12 text-center">
            <p className="text-red-600">Lỗi: Không tải được dữ liệu thử thách.</p>
          </div>
        </div>
      </div>
    );
