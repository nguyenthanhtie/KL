  ...
  game: {
    basic: [
      {
        ...
        options: ["Tính dẻo", "Tính dẫn điện", "Tính tan trong nước", "Ánh kim"],
        correctAnswer: 2,
    ...
    intermediate: [
      ...
      },
      {
        ...
        pairs: [
          { left: "Vàng (Au)", right: "Dẻo nhất" },
          { left: "Crom (Cr)", right: "Cứng nhất" },
          { left: "Vonfram (W)", right: "Nhiệt độ nóng chảy cao nhất" },
          { left: "Liti (Li)", right: "Nhẹ nhất" }
        ],
      ...
      },
      {
        ...
        options: ["Có lớp đồng màu đỏ bám vào Na", "Dung dịch mất màu xanh và có khí thoát ra", "Chỉ có khí thoát ra", "Không có hiện tượng gì"],
        correctAnswer: 1,
    ...
    advanced: [
      {
        ...
        options: ["Tăng 0.1g", "Giảm 0.1g", "Tăng 0.01g", "Giảm 0.01g"],
        correctAnswer: 3,
      ...
      },
      {
        ...
        options: ["Nhiệt phân", "Nhiệt nhôm", "Trung hòa", "Trao đổi"],
        correctAnswer: 1,
