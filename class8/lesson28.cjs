    ...
    basic: [
      {
        ...
        options: ["Nguyên tử khối", "Số nơtron", "Điện tích hạt nhân", "Bán kính nguyên tử"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Chu kỳ 3, nhóm IA", "Chu kỳ 1, nhóm IIIA", "Chu kỳ 3, nhóm IIA", "Chu kỳ 2, nhóm IA"],
        correctAnswer: 0,
    ...
    intermediate: [
      {
        ...
        options: ["Flo (F)", "Lưu huỳnh (S)", "Clo (Cl)", "Photpho (P)"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        pairs: [
          { left: "Nhóm IA", right: "Kim loại kiềm" },
          { left: "Nhóm IIA", right: "Kim loại kiềm thổ" },
          { left: "Nhóm VIIA", right: "Halogen" },
          { left: "Nhóm VIIIA", right: "Khí hiếm" }
        ],
      ...
      },
      {
        ...
        options: ["Chu kỳ 3, nhóm IVA", "Chu kỳ 3, nhóm VIA", "Chu kỳ 4, nhóm VIA", "Chu kỳ 2, nhóm VIA"],
        correctAnswer: 1,
    ...
    advanced: [
      {
        ...
        options: ["Nhóm IIIA", "Nhóm IVA", "Nhóm VA", "Nhóm VIA"],
        correctAnswer: 3,
      ...
      },
      {
        ...
        options: ["H₂SiO₃ < H₃PO₄ < H₂SO₄ < HClO₄", "HClO₄ < H₂SO₄ < H₃PO₄ < H₂SiO₃", "H₂SiO₃ < H₂SO₄ < H₃PO₄ < HClO₄", "Không so sánh được"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["Mg (Z=12)", "Al (Z=13)", "Na (Z=11)", "Si (Z=14)"],
        correctAnswer: 1,
